...
{
    public partial class SpamDetector
    {
        public const string RetrainFilePath =  @"D:\Учебный курс_Инженер-программист\14 Введение в анализ данных\Модуль 3. Анализ данных в ML.NET\email_dataset.csv";
